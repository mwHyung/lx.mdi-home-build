...
const inputVariants = cva(
  "flex w-full border border-pub-grayD bg-background ring-offset-background font-medium placeholder:text-[2.2rem] placeholder:text-pub-grayA placeholder:font-normal file:border-0 file:bg-transparent file:text-sm file:font-medium focus-border disabled:cursor-not-allowed disabled:opacity-50 focus:border-pub-red",
  {
    variants: {
      size: {
        sm: "h-8 text-sm px-2 py-1",
        md: "h-9 text-sm px-2 py-1",
        lg: "text-[2.2rem] px-[2.8rem] py-[1.35rem]",
      },
    },
    defaultVariants: {
      size: "md",
