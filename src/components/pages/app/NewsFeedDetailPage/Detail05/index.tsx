        ...
        <ul className={styles.unordered_list}>
          <li>
            <span>
              ...
              Compression(UCC) 프로젝트'에 대해 최종 투자 결정을 내렸습니다.
              <br />이 프로젝트는 총 70억 달러 규모로, 아시아 국가, 특히 일본에 안정적인 에너지를
              공급할 것입니다.
            </span>
          </li>
          <li>
            <span>
              ...
              증대(EGR), 그리고 육상 압축기 건설로 구성됩니다.
              <br />
              해당 프로젝트는 2028년부터 단계적으로 가동 및 생산을 시작할 예정이며, 인도네시아
              최초로 대규모 CCUS를 활용한 EGR 기술을 도입하여
              <br /> 국가 내 CCUS 기술 확산에 기여할 것으로 기대됩니다.
            </span>
          </li>
          <li>
            <span>
              Tangguh LNG 시설은 연간 1,140만 톤의 LNG를 생산할 수 있는 능력을 갖추고 있으며,
              인도네시아 Papua Barat주의 Bintuni Bay에 위치하고 있습니다.
              <br />
              bp가 SKK Migas와의 생산 공유 계약 하에 운영하며, 프로젝트의 운영을 총괄하고 있습니다.
            </span>
          </li>
        </ul>
      </div>
