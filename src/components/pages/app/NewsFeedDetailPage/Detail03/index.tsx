    ...
    >
      <DetailTitle
        list={{
          ...
          group: "ITOCHU",
          tit: "ITOCHU, 홋카이도 치토세시 물류 시설 개발 발표",
          date: "2025.01.22",
        }}
        ai={true}
      />
        ...
        <ul className={styles.unordered_list}>
          <li>
            <span>
              ...
              계획이라고 발표했습니다. 이 시설은 ITOCHU가 홋카이도에서 처음으로 개발하는 임대형 물
              류 센터로, 반도체 공장 설립 등으로 물류 수요가 증가할 것으로 예상되는 지역적 특성을 반
              영한 결정입니다.
            </span>
          </li>
          <li>
            <span>
              ...
              유리한 교통망을 갖추고 있습니다. 부지는 약 3,000m²에서 7,000m² 크기로 나누어 다양한
              산업의 요 구를 충족할 수 있도록 설계되었습니다. 또한, 재난 발생 시에도 운영을 지속할
              수 있도록 보안 시 스템과 비상 발전기가 설치될 예정입니다.
            </span>
          </li>
          <li>
            <span>
