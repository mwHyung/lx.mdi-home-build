    ...
    >
      <DetailTitle
        list={{
          ...
          group: "ITOCHU",
          tit: "ITOCHU, Kawasaki Motors와 전략적 사업 제휴 체결",
          date: "2024.11.08",
        }}
        ai={true}
      />
        ...
        <ul className={styles.unordered_list}>
          ...
          <li>
            <span>
              ...
              수요를 충족시킬 새로운 제품을 출시할 예정입니다. 특히 4륜 오프로드 차량 시장에서
              판매를 확대할 계획이며, 이에 따른 장기 할부금융 수요가 증가할 것으로 예상됩니다.
            </span>
          </li>
          <li>
            <span>
              ...
              강화할 계획입니다. 양사는 장기적으로 협력 구조를 공고히 하며 지속 가능한 경쟁력을
              구축하고자 합니다.
            </span>
          </li>
        </ul>
